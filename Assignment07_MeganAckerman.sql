...
-- 2024-02-24,MeganAckerman,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_MeganAckerman')
	 Begin 
	  Alter Database [Assignment07DB_MeganAckerman] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_MeganAckerman;
	 End
	Create Database Assignment07DB_MeganAckerman;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_MeganAckerman;
